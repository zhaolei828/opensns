...
class DevtoolController extends AdminController
{
    ...
    {
        $module = D('Module')->getModule($_SESSION['module']);
        $this->module = $module;
    ...
    public function module()
    {
        ...
        $_SESSION['guide_menus'] = null;
        $_SESSION['guide_default_rule'] = null;
        $_SESSION['guide_auth_rule'] = null;
        $_SESSION['guide_action'] = null;
        $_SESSION['guide_action_limit'] = null;
        $_SESSION['guide_sql_tables'] = null;
        $_SESSION['guide_sql_rows'] = null;
    ...
    public function module3()
    {
        ...
        if ($default != '') {
            $_SESSION['guide_default_rule'] = json_encode($default);
        }
        $auth_rule = I('post.auth_rule');
        if ($auth_rule != '') {
            $_SESSION['guide_auth_rule'] = $auth_rule;
        }
    ...
    public function module4()
    {
        ...
        if ($action) {
            $_SESSION['guide_action'] = $action;
        }
        $action_limit = I('post.action_limit', '');
        if ($action_limit) {
            $_SESSION['guide_action_limit'] = $action_limit;
        }
    ...
    public function module5()
    {
        ...
        if ($sql_table) {
            $_SESSION['guide_sql_tables'] = $sql_table;
        }
        if ($sql_table) {
            $_SESSION['guide_sql_drop_table'] = $sql_drop_table;
        }
        if ($sql_rows) {
            $_SESSION['guide_sql_rows'] = $sql_rows;
        }
    ...
    {
        $guide['menu'] = $_SESSION['guide_menus'];
        $guide['default_rule'] = $_SESSION['guide_default_rule'];
        $guide['auth_rule'] = $_SESSION['guide_auth_rule'];
        $guide['action'] = $_SESSION['guide_action'];
        $guide['action_limit'] = $_SESSION['guide_action_limit'];
        return $guide;
    }
